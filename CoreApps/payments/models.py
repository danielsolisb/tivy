# CoreApps/payments/models.py

from django.db import models
from CoreApps.users.models import Customer, Business
...
class Transaction(models.Model):
    ...
    provider = models.CharField(max_length=50, default='payphone')
    provider_tx_id = models.CharField(max_length=255, blank=True, null=True)
